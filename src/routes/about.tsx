    ...
    <div ref={ref}>
      <section className="mx-auto max-w-7xl px-6 lg:px-10 pt-24 lg:pt-36 pb-12" data-reveal>
        ...
        <h1 className="mt-5 font-display text-5xl lg:text-7xl xl:text-8xl leading-[1.02] max-w-5xl">
          A studio for those who carry their <span className="text-accent">roots</span> wherever
          they go.
        </h1>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 lg:px-10 grid lg:grid-cols-12 gap-12 pb-24 lg:pb-32">
        ...
        <div
          className="lg:col-span-5 space-y-6 text-muted-foreground leading-[1.8]"
          data-reveal
          data-reveal-delay="2"
        >
      ...
      <section className="bg-secondary py-24 lg:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-10 grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div data-reveal data-reveal-delay="2">
            ...
            <ul className="mt-10 space-y-6">
              {[
                ...
                <li key={t} className="border-b border-border pb-5 group">
                  <div className="font-display text-2xl tracking-tight group-hover:text-accent transition-colors">
                    {t}
                  </div>
            ...
            <Link
              to="/custom-order"
              className="btn-pill mt-12 inline-flex items-center gap-2 bg-foreground text-primary-foreground px-7 py-4 text-xs font-bold uppercase tracking-[0.28em] hover:bg-accent hover:text-accent-foreground transition-colors duration-500"
            >
